	...
	public TelaListaAnamnese(Usuario usuarioAtual) {
		...
		public void mouseClicked(MouseEvent e) {
			...
			for (Anamnese anamnese : aDao.listarAnamnese()) {
				if(id.equals(anamnese.getAlergias())) {
		...
		btnAdicionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				anaSelecionda=null;
				dispose();
				TelaAnamnese tela = new TelaAnamnese(usuarioAtual, null, anaSelecionda, editar);
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(linha==-1) {
					...
					editar = true;
					dispose();
					TelaAnamnese telaAlterar = new TelaAnamnese(usuarioAtual, null, anaSelecionda, editar);
