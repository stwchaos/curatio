...
public class TelaCadastroPaciente extends JFrame {
	...
	public TelaCadastroPaciente() {
		...
		setContentPane(c);
		c.setLayout(new MigLayout("", "[171.00,grow][350.00px,grow][197.00,grow]", "[479.00px,grow]"));
		...
		panel.setLayout(new MigLayout("", "[grow][58px,grow][11px][32px][5px][121px,grow][10px][69px,grow]",
				"[36px,grow][191px][][23.00px][bottom][19.00px][center][][][][18.00][22.00][21.00px,grow][grow]"));

		JPanel panel_1 = new JPanel();
		panel_1.setBackground(Color.WHITE);
		panel.add(panel_1, "cell 3 1 3 1,grow");
