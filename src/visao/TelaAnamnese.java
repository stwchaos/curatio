...
public class TelaAnamnese extends JFrame {
	...
	public TelaAnamnese() {
		...
		contentPane.setLayout(new MigLayout("", "[80.00][grow][-19.00][grow][][][][][][][][][][][][103.00][20.00,grow][][][][][][][][][][][][][][grow][80]", "[grow][][grow][][][][][][][][grow][]"));
		...
		panel_1.setLayout(new MigLayout("", "[grow]", "[32][][61.00][][61][][61][][61][][61][][61][][61][][61][][61][27.00][61][35][61]"));
