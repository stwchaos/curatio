...
public class TelaCadastrarProfisional extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TelaCadastrarProfisional(final Usuario usuarioAtual, final Medico medicoSelecionado, final Boolean editar, final Funcionario funcionarioSelecionado) {
